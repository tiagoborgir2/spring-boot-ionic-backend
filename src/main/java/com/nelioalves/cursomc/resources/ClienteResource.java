...
public class ClienteResource {
	 ...
	 * ResponseEntity<Cliente> find(@RequestParam(value="value") String email) {
	 * Cliente obj = service.findByEmail(email); return
	 * ResponseEntity.ok().body(obj); }
	 * 
	 * 
	 * @RequestMapping(method=RequestMethod.POST) public ResponseEntity<Void>
	 * insert(@Valid @RequestBody ClienteNewDTO objDto) { Cliente obj =
